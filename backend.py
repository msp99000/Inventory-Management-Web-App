...
store = pd.read_pickle('../data/store.pkl')
item_data = pd.read_pickle('../data/items.pkl')
customer = pd.read_pickle('../data/customers.pkl')
sales = pd.read_pickle('../data/sales.pkl')
